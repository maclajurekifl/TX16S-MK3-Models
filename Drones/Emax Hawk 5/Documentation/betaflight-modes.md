...
| Line | Meaning |
|------|---------|
| `aux 0 0 1 …` | **ARM** on **AUX2** (CH6) high — **SF Down** armed / **SF Up** disarmed |
...
Radio arm mix is **reversed** (`weight: -100`) so **SF Up** = thr cut + CH6 low (disarmed), **SF Down** = CH6 high (armed).
